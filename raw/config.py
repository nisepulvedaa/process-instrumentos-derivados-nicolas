...
nombre_tabla_raw="tbl_instrumento_derivado_dia_nicolas"
campo_fecha_tabla_raw="fec_periodo"
fecha_ejecucion="2025-04-24"
ddl_raw="CREATE TABLE IF NOT EXISTS`deinsoluciones-serverless.dev_raw_zone.tbl_instrumento_derivado_dia_nicolas` (fec_periodo DATE,cod_filial STRING,rut_deudor STRING,cod_operacion STRING,tip_derivado STRING,monto STRING,ind_netting STRING,sistema_origen STRING,fecha_carga TIMESTAMP ) PARTITION BY fec_periodo;"
##
